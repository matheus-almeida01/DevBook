...
func (repositorio Usuarios) Seguir(usuarioID, seguidoID uint64) error {
	...
	if _, erro = statement.Exec(usuarioID, seguidoID); erro != nil {
		return erro
	}
...
// BuscarSeguindo traz todos os usuario que um determinado usuario esta seguindo
